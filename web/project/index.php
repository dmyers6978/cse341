    ...
    case 'status':
        ...
        if($_SESSION['userData']['userlevel'] === 2){
            ...
            foreach($jobList as $job){
                ...
                $table .= "</select><input type='hidden' name='action' value='editStatus'><input type='hidden' name='jobId' value='$job[jobid]'><input type='submit' value='Change Status'></form></td><td>".date_format(date_create($job['datetime']), 'd-m-Y H:i:s')."</td></tr>";
            }
            $table .= "</tbody></table>";
